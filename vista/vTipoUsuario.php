<?php
include("controlador/cTipoUsuario.php")
?>

<div align="left"><br>
<h3>Ingresar Tipos de Usuarios</h3>
<div class="form-group">
	<br><br><form id="formTipoUsu" name = "formTipoUsu" method="POST" action="" class="form-horizontal">
...
<div class="table-responsive">
	<br/><br/><h3>Tipos de Usuarios Activos</h3>
...
<table class="table table-bordered table-hover table-striped">
	...
	<tbody>
		...
		?>
		<tr>
			<td><?php echo$dat[$i]['IdTipoUsuario']?></td>
			<td><?php echo$dat[$i]['Nombre']?></td>
			<td align = "center"><a href = "home.php?pr=<?php echo $dat[$i]['IdTipoUsuario'] ?>&pac=<?php echo $pac; ?>&up=102"><input type="button" name="del" value="Editar"/></a>
			<button value="<?php echo $dat[$i]['IdTipoUsuario']?>" name="del">Eliminar</button></a></td>
		</tr>
		<?php
			}
		?>
